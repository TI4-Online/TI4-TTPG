...
class RightClickNanoForge extends AbstractRightClickCard {
    ...
    isRightClickable(card) {
        ...
        return nsid === "card.relic:codex.affinity/nanoforge";
    }
    ...
    onRightClick(card, player, selectedActionName) {
        if (selectedActionName === ACTION_NAME) {
            ...
            RightClickNanoForge.fetchAttachmentToken(card, tokenNsid);
        }
    }
}

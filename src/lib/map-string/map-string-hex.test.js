...
const fourth_ring = [{q:4,r:0,s:-4},{q:3,r:1,s:-4},{q:2,r:2,s:-4},{q:1,r:3,s:-4},{q:0,r:4,s:-4},
    {q:-1,r:4,s:-3},{q:-2,r:4,s:-2},{q:-3,r:4,s:-1},{q:-4,r:4,s:0},
    {q:-4,r:3,s:1},{q:-4,r:2,s:2},{q:-4,r:1,s:3},{q:-4,r:0,s:4},
    {q:-3,r:-1,s:4},{q:-2,r:-2,s:4},{q:-1,r:-3,s:4},{q:0,r:-4,s:4},
    {q:1,r:-4,s:3},{q:2,r:-4,s:2},{q:3,r:-4,s:1},{q:4,r:-4,s:0},
    {q:4,r:-3,s:-1},{q:4,r:-2,s:-2},{q:4,r:-1,s:-3}];
...
it('hexToId : test fourth ring', () => {
    for(var i = 0 ; i < 24 ; i++) {
        ...
        assert.equal(hexToIdx(hex.q, hex.r, hex.s), i+37, "Error on step i=" + i)
    }
})
